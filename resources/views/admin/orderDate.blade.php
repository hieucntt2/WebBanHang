...
@section('content')
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex">
                        <input type="date" id="date" class="border-0 form-control">
                        <label for="" class="btn-primary btn btn-search-date " style="margin-left: 1rem">Hiện</label>
                    </div>
                </div>
        ...
        <button class="btn btn-primary print-order">In Excel</button>
