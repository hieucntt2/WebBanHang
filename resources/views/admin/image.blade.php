    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            ...
            <form class="d-none d-md-flex ms-4">
                ...
                <button class="btn btn-primary btn-search-image" style="margin-left: 2rem;">Search</button>
            </form>
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        <a href="#" class="dropdown-item">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle" src="../img/50.webp" alt=""
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Danh sách ảnh sản phẩm</h6>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody id="get-item">
                            ...
                            <tr>
                                <td>{{$item->MaAnh}}</td>
                                <td>{{$item->TenSP}}</td>
                                <td><img src="../../img/{{$item->URL}}" alt="{{$item->TenSP}}"></td>
                                <td>
            ...
            <div class="row">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form>
                            <div class="mb-3">
                                <label for="select-sp" class="form-label">Tên sản phấm</label>
                                <select class="form-select" id="select-sp"
